    ...
    const createSession = async(e) => {
        ...
        e.preventDefault()
         var myHeaders = new Headers();
          ...
          .then(response => response.json())
          .then(result => {
              console.log("Cohort session edit response",result)
              // setProgramList(result.programList)
              if(result.success){
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-12 mb-25">
                              <div class="countryOption">
                                  ...
                                  {state && state?.fullDate?.data?.skills?.split(",")?.map((i) => (
...
export default Edit_Cohort_Session;
