...
function Program_Settings_Progress() {
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    <div className="layout-button">
                                        ...
                                        <button type="button" className="btn btn-outline-primary btn-squared color-primary px-15">Confirmed Participants</button>
...
export default Program_Settings_Progress;
