                                ...
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    <div className=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                        <div className="d-flex align-items-center user-member__title justify-content-center me-sm-25">
                                            <h2 className="text-capitalize fw-500 breadcrumb-title">Activity</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                      ...
                                      <div style={{cursor:'pointer'}} className="box_shadow1 p-15 notifi">
                                        <div className="event-Wrapper">
                                          <div className="event-Wrapper__left">
                                            <div style={{backgroundColor:'#fdefe6'}} className="event-wrapper-item">
                                              <img
                                                src={activity_icon} className="svg"
                                              />
                                            </div>
                                          </div>
