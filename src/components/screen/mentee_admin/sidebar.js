...
function Side_bar({ onClick, sideBarOpen }) {
    ...
    const acceptSession = async (val) => {
        ...
        const res = await fetch(`${BASE_URL}session/reschedule/${payload.sessionId}`, {
            method: 'PUT',
            headers: {
                "Accept": "application/json",
                'Content-Type': 'application/json',
                    ...
                    <div className="navbar-right">
                        <ul className="navbar-right__menu">
                            <div className="d-flex align-items-center user-member__form my-sm-0 my-2">
                                ...
                                }} onClick={() => navigate('/browse_mentee')} className="me-sm-2 border-0 box-shadow-none ms-10" type="search" placeholder="Browse Mentors" aria-label="Search" />
                            </div>
                            ...
                            <li className="nav-notification">
                                <div className="dropdown-custom">
                                    ...
                                    {showNotification ?
                                        ...
                                        //             ))}
                                        //         </ul>
                                        //         <div className="dropdown-wrapper__more color-green">View All</div>
                                        //     </div>
                                        // </div> 
                                        <div className="dropdown-parent-wrapper">
                            ...
                            <li className="nav-message">
                                <div className="dropdown-custom">
                                    {/* <a href="#" className="nav-item-toggle icon-active"> */}
                                    <img onClick={() => setMessage(!showMessage)} src={message_img} className="svg" />
                                    {/* </a> */}
                                    {showMessage ?
                                        <div className="dropdown-parent-wrapper">
                                            <div className="dropdown-wrapper">
                        ...
                        <div className="sidebar__menu-group">
                            <ul className="sidebar_nav">
                                ...
                                <li className="nav-author1 mb-25">
                                    <div style={{ height: "75px" }} className="nav-author__info1 kris">
                                ...
                                <li>
                                    <NavLink className="navbar-link" to="/my_mentor">
                                        <span className="nav-icon">
                ...
                <Modal.Body>
                    <div className="text-center">
                        ...
                        <div class="layout-button justify-content-center">
                            ...
                            <button onClick={() => acceptSession(1)} type="button" className="btn btn-light-petrol btn-default btn-squared">Accept</button>
                        </div>
                    </div>
