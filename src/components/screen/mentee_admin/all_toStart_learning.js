  ...
  const onPointerMove = (value, index) => console.log(value, index)
    ...
    const getAllStartedLearning = async() => {
      ...
      const body = {
        ...
        "condition":"not-started"//in-progress,completed,not-started
    }
                          ...
                          <div style={{display:'flex',justifyContent:'space-between'}}>
                            <div>
                                    ...
                                    <div className="layout-button">
                                        <button onClick={() =>navigate("/learning_profile_detail", {state:{data:user, hint: "start"}})} type="button" className="btn btn-light-petrol btn-default btn-squared flex-grow-1 ment_btn">View</button>
                                        {/* {user.menteeRating == 0 &&
...
export default All_ToStart_Learning