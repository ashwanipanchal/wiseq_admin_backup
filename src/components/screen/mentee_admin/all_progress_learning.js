...
function All_Progress_Learning() {
  ...
  const onPointerMove = (value, index) => console.log(value, index)
    ...
    useEffect(() => {
      getAllStartedLearning()
    },[])

    // const getAllCompletedLearning = async() => {
    //     const btoken = `Bearer ${token}`;
    //     const res = await fetch(`${BASE_URL}mentee-learnings/to-start`, {
    //         method: 'GET',
    //         headers: {
    ...
    const getAllStartedLearning = async() => {
      const btoken = `Bearer ${token}`;
      const body = {
        "mentee_id":localStorage.getItem("user_id"),
        "condition":"in-progress"//in-progress,completed,not-started
    }
                ...
                <div className="col-lg-12">
                  <div className="breadcrumb-main user-member justify-content-sm-between">
                    ...
                    {/* <div
                      ...
                      onClick={() => {
                        navigate("/all_Progress_learning")
                      }}
                    ...
                    <div class="user-group px-25 pt-25 pb-20 radius-xl">
                      <div class="user-group-people">
                        ...
                        <ul class="d-flex flex-wrap mb-10 user-group-people__parent">
                          ...
                          <p class="mb-0 fs-12">Source: <span class="color-dark fs-12 fw-400">{user?.sourceName}</span></p>
                          ...
                          <div style={{display:'flex',justifyContent:'space-between'}}>
                            <div>
                                    ...
                                    <div className="layout-button">
                                        <button onClick={() =>navigate("/learning_profile_detail", {state:{data:user, hint: "progress"}})} type="button" className="btn btn-light-petrol btn-default btn-squared flex-grow-1 ment_btn">View</button>
                                        {/* {user.menteeRating == 0 &&
...
export default All_Progress_Learning