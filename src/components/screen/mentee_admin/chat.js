...
function Chat_Screen() {
    ...
    //     // const docId = 1 > 2 ? 2 + "-" + 1 : 1 + "-" + 2
    //     const docId = state.id || clickedUserID + "-" + userInfo;
                ...
                <div className="chat-area d-flex mb-40">
                            ...
                            <div id="chat" className="left-sidebar-wrap radius-xl active">
                                <div className="chat-wrapper py-25">
                                    ...
                                    <div className="search-body">
                                        ...
                                        {filterChat.map((i)=>(
                                               <div style={{backgroundColor: i.userId == toCheckColor ? "#EBF3F3": "white"}} onClick={() => {
                                                setChatPersonID(i.userId)
                                                getDATA1(i.userId)
                                                setUserTitle(i.jobTitle)
                                                setUserName(i.userName)
                                                setClickedUserID(i.userId)
                                                setImageUrl(i.imageUrl)
                                                setToCheckColor(i.userId)
                                            }
                                                
                                                } className="box_shadow1 notifi bg-petrol mb-15">
                    ...
                    <div className="chat box_shadow1">
                        <div className="chat-body bg-white radius-xl">
                                ...
                                <div className="media chat-name align-items-center">
                                    <div className="media-body align-self-center ">
                                        <div className="media-body d-flex align-items-center">
                                            <img src={state.imageUrl == "" ? authornav_img : state.imageUrl} className="me-20 wh-50 rounded-circle bg-opacity-primary" />
                                            <div>
                            ...
                            {/* Button Options */}
                            <div className="chat-footer px-xl-30 px-lg-20 pt-20 pb-20 pt-1">
