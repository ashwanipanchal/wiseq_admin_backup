                                        ...
                                        <div className="tab-wrapper">
                                            <div className="dm-tab tab-horizontal">
                                                <Tabs defaultIndex={0} onSelect={(index) => fetchListData(index)}>
                                                    <TabList className="nav nav-tabs vertical-tabs menteer-tab">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                {/* {data.map((user) => ( */}
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div style={{cursor:"pointer", color:'#80CED6'}} onClick={() => navigate("/mentoring_program_upcoming",{state:user})} className="userDatatable-content">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                {/* {data1.map((user) => ( */}
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div style={{cursor:"pointer", color:'#80CED6'}} onClick={() => navigate("/mentoring_program_progress",{state:user})} className="userDatatable-content">
                                                                                            {user?.program_model?.name.substring(0,
                                                                                                    4
                                                                                                    )}
                                                                                                    {user?.program_model?.name.length >
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            {index == indexValue1 && (
                                                                                                <div className="dropdown-menu dropdown-menu--dynamic box_shadow1">
                                                                                                    <NavLink className="" to="/mentoring_program_progress" state={user}><div className="dropdown-item">view Details</div></NavLink>
                                                                                                </div>
                                                                                            )}
                                                                                            {/* {showFilter ?
                                                                                                <div className="dropdown-menu dropdown-menu--dynamic box_shadow1">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                {/* {data.map((user) => ( */}
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <td>
                                                                                            <div style={{cursor:"pointer", color:'#80CED6'}} onClick={() => navigate("/mentoring_program_completed",{state:user})} className="userDatatable-content">
                                                                                            {user?.program_model?.name.substring(0,
                                                                                                    4
                                                                                                    )}
                                                                                                    {user?.program_model?.name.length >
                                                                                        ...
                                                                                        <td>
                                                                                            ...
                                                                                            {index == indexValue2 && (
                                                                                                <div className="dropdown-menu dropdown-menu--dynamic box_shadow1">
                                                                                                    <NavLink className="" to="/mentoring_program_completed" state={user}><div className="dropdown-item">view Details</div></NavLink>
                                                                                                </div>
                                                                                            )}
                                                                                            {/* {showFilter ?
                                                                                                <div className="dropdown-menu dropdown-menu--dynamic box_shadow1">
