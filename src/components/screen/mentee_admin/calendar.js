...
function Calendar_Open() {
    ...
    //    console.log( Date.parse(`${date}T${time}`))
    //     return
    e.preventDefault()
    if(mentorID == ""){
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between ">
                                    ...
                                    <div className="action-btn">
                                        <div className="btn px-15 btn-light-petrol ment_btn">Sync Calendar</div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="">
                                        <form onSubmit={createSession}>
                                            <div className="row">
                                                ...
                                                <h6 class="fw-500 mb-20 mt-20">Schedule a session</h6>
                                                ...
                                                <div className="col-md-12 mb-25">
                                                <div class="countryOption">
                                                <select value={timeValue} onChange={e => setTimeValue(e.target.value)} class="form-select form-control ih-medium ip-gray radius-xs b-deep px-15" aria-label="Default select example" required>
                                                            <option value="">Select Available Time</option>
                                                            {availableTime.map((i, index) => (
                                                                <option value={index}>{moment(i.startTime).format("HH:mm")} - {moment(i.endTime).format("HH:mm")}</option>
                                                            ))}
                                                ...
                                                <div className="col-md-12">
                                                    <button type="submit" className="btn btn-light-petrol btn-default btn-squared w-100 ment_btn">Save</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
