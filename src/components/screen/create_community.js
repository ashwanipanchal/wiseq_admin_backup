                                ...
                                <div className="breadcrumb-main user-member justify-content-sm-between ">
                                    <div className=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                        <div className="d-flex align-items-center user-member__title justify-content-center me-sm-25">
                                            <h4 className="text-capitalize fw-500 breadcrumb-title">Create Community</h4>
                                        </div>
                                    </div>
                                        ...
                                        <form>
                                            <div className="row">
                                                ...
                                                <div className="col-md-12">
                                                    <div className="mt-0">
                                                        <NavLink className="navbar-brand" to="/community_screen"><button type="button" className="btn btn-primary btn-default btn-squared m-auto">Create</button></NavLink>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
