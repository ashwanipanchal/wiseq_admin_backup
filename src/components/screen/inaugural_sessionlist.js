...
function Inaugural_SessionList() {
    ...
    const getSessions = async () => {
        ...
        var raw = JSON.stringify({
          ...
          "condition":"inaugural"//group,inaugural
      });
                                ...
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    <div className=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                        <div className="d-flex align-items-center user-member__title justify-content-center me-sm-25">
                                            <h4 className="text-capitalize fw-500 breadcrumb-title">Schedule a Inaugural Session</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul className="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                                    ...
                                                                    <li>
                                                                        <button onClick={() => navigate("/edit_inaugural_session",{state:i})} className="btn px-15 btn-primary ms-10">
                                                                            Edit
                                                                        </button>
                                                                    </li>
                                                                </ul>
...
export default Inaugural_SessionList;
