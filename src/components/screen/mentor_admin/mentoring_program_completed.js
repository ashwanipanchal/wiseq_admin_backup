                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    <div class="layout-button">
                                        <button type="button" className="btn btn-outline-petrol btn-default btn-squared">Rate</button>
                                        <button type="button" className="btn btn-outline-petrol btn-default btn-squared" onClick={showModal}>Write a testimonial</button>
                                        <NavLink className="navbar-link" to="/program_statistics"><button type="button" className="btn btn-petrol btn-squared color-primary">Program Statistics</button></NavLink>
                                    </div>
            ...
            <Modal show={showHello} onHide={closeModal}>
                ...
                <Modal.Body>
                    ...
                    <form>
                        <div className="row">
                            <div className="col-md-12 mb-25">
                                <textarea class="form-control ip-gray radius-xs b-deep px-15" id="exampleFormControlTextarea1" rows="4" placeholder="Write..."></textarea>
                            </div>
