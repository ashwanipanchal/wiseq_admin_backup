              ...
              <div className="row">
                <div className="col-lg-12 col-sm-12 col-md-12 mb-25">
                  {/* <div className="media user-group-media d-flex justify-content-between">
                                    ...
                                    {(userInfo && 
                                    <>
                                    <img src={userInfo.imageUrl == "" ? authornav_img : userInfo.imageUrl} className="me-20 wh-70 rounded-circle bg-opacity-primary" />
                                        ...
                                        <img style={{cursor:'pointer'}} onClick={() => navigate('/edit_profile',{state:userInfo})} src={edits_img} className="svg ms-20 mt-4" />
                                    </div>
...
<div className="ap-po-details ap-po-details--2 p-15 radius-xl d-flex justify-content-between box_shadow1">
                    ...
                    <div className="media-body d-flex align-items-center">
                      {userInfo && (
                        <>
                          ...
                          <div>
                            <h3 className="fw-500 mb-2">
                              {userInfo.userMeta.name}
                            </h3>
                            <p className="fs-13 color-light mb-0">
                              EID #{userInfo.empId} | {userInfo.jobTitle}
                            </p>
                          </div>
                        </>
                      )}
                      ...
                      <img
                        onClick={() =>
                          navigate("/edit_profile", { state: userInfo })
                        }
                        src={edits_img}
                        className="svg ms-20 mt-4"
                      />
                    </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.yearsOfExperience}
                  </p>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.yearsWithCompany}
                  </p>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.functionalArea}
                  </p>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.userMeta.email}
                  </p>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  <div className="svg-icon">
                    <img
                      src={linkdin_img}
                      onClick={() => {userInfo.linkedinProfileLink != null && window.open(`${userInfo.linkedinProfileLink}`, "_blank") }}
                      className="svg me-30"
                    />
                    <img
                      src={website_img}
                      onClick={() =>{userInfo.linkedinProfileLink != null && window.open(`${userInfo.websiteLink}`, "_blank") }}
                      className="svg"
                    />
                  </div>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.designationLevel}
                  </p>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.reportingManagerName}
                  </p>
                </div>
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <ul className="d-flex flex-wrap user-group-people__parent">
                    {userInfo &&
                      userInfo.expertise.businessSkillsGoodAt.map((i) => (
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  {/* <ul className="d-flex flex-wrap user-group-people__parent"> */}
                  {userInfo &&
                    userInfo.expertise.tools?.map((i) => (
                ...
                <div className="col-lg-12 col-md-12 mb-20">
                  ...
                  <ul className="d-flex flex-wrap user-group-people__parent">
                    {userInfo &&
                      userInfo.expertise?.coreSkillsGoodAt.map((i) => (
                ...
                <div className="col-lg-6 col-md-12 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-300 align-center mb-0">
                    {userInfo &&
                    userInfo.expertise?.hasOwnProperty("aspirationalGoals")
                      ? userInfo.expertise?.aspirationalGoals[0]
                      : ""}
                  </p>
                </div>
                ...
                {/* <div className="row mt-10">
                                <div className="col-md-2 mb-20">
                                    ...
                                    <p className="color-dark fs-14 fw-300 align-center mb-0">Hindi</p>
                                </div>

                                <div className="col-md-2 mb-20">
                                    <p className="color-gray fs-14 fw-300 align-center mb-0">Proficiency</p>
                                    <p className="color-dark fs-14 fw-300 align-center mb-0">Proficient</p>
                                </div>
                ...
                <h5 className="text-capitalize fw-600 mb-20 mt-3">Location</h5>
                ...
                <div className="col-md-6 mb-20">
                  ...
                  <p className="color-dark fs-14 fw-600 align-center mb-0">
                    {userInfo && userInfo.workLocation}
                  </p>
                </div>
                  ...
                  <div className="tab-content">
                    <div className="project-task table-responsive table-responsive--dynamic">
                      <table className="table table-borderless mb-1">
                        <tbody>
                          {userInfo &&
                            userInfo.keyAchievements?.map((user) => (
                              <tr className="project-task-list">
                                <td>
                                  <div className="box_shadow1 p-15">
                                    <div className="event-Wrapper">
                ...
                {/* {userInfo &&
                  userInfo.userTestimonials?.map((i) => (
                    <div className="col-lg-12 col-sm-12 col-md-12 mb-25">
                ...
                <h5 className="text-capitalize fw-600 mb-15">
                  Your Preferences
                  <span
                    onClick={() => navigate("/preference_one")}
                    style={{
                      fontSize: "12px",
                ...
                {userInfo &&
                  userInfo.preferences?.map((i, index) => (
                ...
                {/* 
                            <div className="col-lg-6 col-sm-12 col-md-12 mb-25">
                                <div className="card border-0 px-20 pb-10 project-task-list--event box_shadow1">
                                    <div className="card-header px-0 border-0">
                                        <h6 className="color-dark fs-16 fw-600">Q1.  What brings you to the platform</h6>
                                    </div>
                                    <div className="card-body p-0">
                                        <div className="tab-content">
                                            <div className="project-task table-responsive table-responsive--dynamic">
                            ...
                            <div className="col-lg-6 col-sm-12 col-md-12 mb-25">
                                <div className="card border-0 px-20 pb-10 project-task-list--event box_shadow1">
                                    <div className="card-header px-0 border-0">
                                        <h6 className="color-dark fs-16 fw-600">Q2. Rate in order of preference your learning style from the below</h6>
                                    </div>
                                    <div className="card-body p-0">
                                        <div className="tab-content">
                                            <div className="project-task table-responsive table-responsive--dynamic">
                            ...
                            <div className="col-lg-6 col-sm-12 col-md-12 mb-25">
                                <div className="card border-0 px-20 pb-10 project-task-list--event box_shadow1">
                                    <div className="card-header px-0 border-0">
                                        <h6 className="color-dark fs-16 fw-600">Q3. What is your need as a mentee</h6>
                                    </div>
                                    <div className="card-body p-0">
                                        <div className="tab-content">
                                            <div className="project-task table-responsive table-responsive--dynamic">
                            ...
                            <div className="col-lg-6 col-sm-12 col-md-12 mb-25">
                                <div className="card border-0 px-20 pb-10 project-task-list--event box_shadow1">
                                    <div className="card-header px-0 border-0">
                                        <h6 className="color-dark fs-16 fw-600">Q4. Your Ideal mentor would</h6>
                                    </div>
                                    <div className="card-body p-0">
                                        <div className="tab-content">
                                            <div className="project-task table-responsive table-responsive--dynamic">
