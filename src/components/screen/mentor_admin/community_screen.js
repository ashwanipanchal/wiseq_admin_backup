                ...
                <div className="demo5 mt-30 mb-25">
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    {/* <div className="action-btn">
                                        <NavLink className="navbar-brand" to="/Create_Community"><div className="btn px-15 btn-petrol">Create Community</div></NavLink>
                                    </div> */}
                                </div>
                            </div>
                            ...
                            <div className="col-lg-12">
                                <h4 class="text-capitalize fw-500 mb-20">Suggested Community</h4>
                            </div>
                                    ...
                                    <div class="blog-card blog-card--2 box_shadow1">
                                        ...
                                        <div class="blog-card__details pt-1 pb-20 px-20">
                                            ...
                                            <div class="layout-button">
                                                <button type="button" class="btn btn-approve btn-default btn-squared flex-grow-1">Join</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
