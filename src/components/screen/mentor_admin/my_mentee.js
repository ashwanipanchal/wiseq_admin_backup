...
function My_Mentee() {
    ...
    const getRequestList = async () => {
        ...
        const res = await fetch(`https://api.wiseqglobal.com/api/match-making/requests`, {
            method: 'GET',
            headers: {
                            ...
                            <div className="breadcrumb-main user-member justify-content-sm-between">
                                <div className=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                    <div className="d-flex align-items-center user-member__title justify-content-center me-sm-25">
                                        <h4 className="text-capitalize fw-500 breadcrumb-title">My Mentees</h4>
                                    </div>
                                </div>

                                <div style={{ cursor: 'pointer' }} onClick={() => {
                                    setShowMore(!showMore)
                                }} class="view_all text-center color-petrol">{showMore ? "View Less" : "View All"}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                            ...
                            <div className="col-lg-4 col-sm-4 col-md-12 mb-25">
                                <div className="user-group px-25 pt-25 pb-20 radius-xl box_shadow1">
                                    ...
                                    <div className="user-group-people">
                                        ...
                                        <ul className="d-flex flex-wrap mb-15 user-group-people__parent">
                                            {/* {user.skills.length == 0 &&
                                                (<span class="badge badge-square btn-outline-dan me-10 mb-10">No Skill Found</span>)
                                            } */}
                                            {user.skills.map((i) => (
                                            ...
                                            {/* <span className="badge badge-square btn-outline-emlpoyes me-10">{user.mentee_employee}</span>
                                    ...
                                    <div className="layout-button">
                                        ...
                                        <button onClick={() => navigate("/chat", { state: user })} type="button" className="btn btn-petrol btn-default btn-squared flex-grow-1">Chat</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        {requestList && requestList.length > 0 && (
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    }} class="view_all text-center color-petrol">{showMoreR ? "View Less" : "View All"}
                                    </div>
                                </div>
                            </div>
                        ...
                        {requestList && requestList.slice(0, 3).map((user) => (
                            <div className="col-lg-4 col-sm-4 col-md-12 mb-25">
                                <div className="user-group px-25 pt-25 pb-20 radius-xl box_shadow1">
                                    ...
                                    <div className="layout-button">
                                        <button onClick={() => navigate('/mentee_profile', { state: user, path:"1" })} type="button" className="btn btn-default btn-squared color-petrol btn-outline-petrol flex-grow-1 px-10">View Profile</button>
                                        {user.requestedByMe ?
                                            <button type="button" className="btn btn-request-petrol btn-default btn-squared flex-grow-1"> Requested </button> :
                                            <>
                                            <button onClick={() => acceptReqst(user.id)} type="button" className="btn btn-petrol btn-default btn-squared flex-grow-1 px-25"> Accept </button>
                                        ...
                                        {/* <button onClick={() => acceptReqst(user.id)} type="button" className="btn btn-petrol btn-default btn-squared flex-grow-1"> Accept </button> */}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-12">
                            <div className="breadcrumb-main user-member justify-content-sm-between">
                                ...
                                }} class="view_all text-center color-petrol">{showMoreRC ? "View Less" : "View All"}
                                </div>
                            </div>
                        </div>
                        ...
                        {recomanded && recomanded.slice(0, 3).map((user) => (
                            <div className="col-lg-4 col-sm-4 col-md-12 mb-25">
                                <div className="user-group px-25 pt-25 pb-20 radius-xl box_shadow1">
                                    ...
                                    <div className="layout-button">
                                        <button onClick={() => navigate('/mentee_profile', { state: user,path:"2"  })} type="button" className="btn btn-default btn-squared color-petrol btn-outline-petrol flex-grow-1 px-10">View Profile</button>
                                        {!user.isRequested ?
                                            <button onClick={() => sendRequest(user.id)} type="button" className="btn btn-petrol btn-default btn-squared flex-grow-1">Connect</button>:
                                            user.requestedByMe ?
                                            <button type="button" className="btn btn-request-petrol btn-default btn-squared flex-grow-1"> Requested </button> :
                                            <>
                                            <button onClick={() => acceptReqst(user.id)} type="button" className="btn btn-petrol btn-default btn-squared flex-grow-1 px-25"> Accept </button>
