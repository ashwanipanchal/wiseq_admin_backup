                ...
                <div className="chat-area d-flex mb-40">
                    ...
                    <div className="chat box_shadow1">
                        <div className="chat-body bg-white radius-xl">
                                ...
                                <div className="media chat-name align-items-center">
                                    <div className="media-body align-self-center ">
                                        <div className="media-body d-flex align-items-center">
                                            <img src={imageUrl  == "" ? authornav_img : imageUrl} className="me-20 wh-50 rounded-circle bg-opacity-primary" />
                                            <div>
                            ...
                            {/* Button Options */}
                            <div className="chat-footer1 px-xl-30 px-lg-20 pt-20 pb-20 pt-1">
