                    ...
                    <div className="col-md-12 mb-15">
                      <div className="ap-po-details-content d-flex flex-wrap justify-content-between align-center join_requests">
                        <div className="media-body d-flex align-items-center">
                          <img
                            src={i.imageUrl == "" ? authornav_img : i.imageUrl}
                            className="me-20 wh-50 rounded-circle bg-opacity-primary"
                          />
                          <div>
                        ...
                        <button
                          onClick={() => {
                            ...
                            // removeAudience(i.userId)
                        }}
                          style={{ backgroundColor: "#EF4F5F", color: "#fff" }}
                          className="btn"
                        >
                          Remove
                        </button>
