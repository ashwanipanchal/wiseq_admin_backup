...
function Selected_Mentors() {
    ...
    const closeModal = () => {
        localStorage.setItem("selected_mentors", JSON.stringify(state.myState))
        setShowHello(false)
        navigate(-2)
    };
    ...
    const addMentors = async() => {
        if(state.hasOwnProperty('from')){
            ...
            var raw = JSON.stringify({
                "program_id": state?.data?.myState?.id,
                "userIds":addedUser
            });
        ...
        //   return
            ...
            fetch(`${BASE_URL_APPLSURE_MENTORING}program-users-addmore`, requestOptions)
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    <div className="layout-button">
                                        <button type="button" className="btn btn-primary btn-default btn-squared" onClick={ () => addMentors()}>Confirm Selection</button>
                                    </div>
            ...
            <Modal show={showHello} onHide={closeModal}>
                ...
                <Modal.Body>
                    <div className="text-center">
                        ...
                        <h4 class="text-capitalize fw-500">Mentors Added Successfully!</h4>
                    </div>
...
export default Selected_Mentors;
