    ...
    const getFullDetails = async() => {
        var myHeaders = new Headers();
          ...
          .then(result => {
              ...
              setData([
                { id: 1, mentoring_hours: "Mentees", mentoring_num: result.totalmenteeinvite },
                { id: 2, mentoring_hours: "Mentors", mentoring_num: result.totalmentorinvite },
                            ...
                            <div className=" d-flex flex-wrap breadcrumb-main__wrapper">
                                ...
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    <div class="layout-button">
                                        ...
                                        <NavLink className="navbar-link" to="/program_progress" state={{state}}><button type="button" className="btn btn-outline-primary btn-squared color-primary">Program Statistics</button></NavLink>
                                    </div>
                                            ...
                                            <div className="overview-content w-100">
                                                <div className=" ap-po-details-content d-flex flex-wrap justify-content-between">
                                                    <div className="ap-po-details__titlebar">
                                                        ...
                                                        <h2 className="color-orange half_done">Half Done</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
