...
function Edit_Created_Learning() {
    ...
    const getProfile = async() => {
        ...
        const response = await res.json()
        console.log("created profile template details in org", response)
    ...
    const updateLearning = async(e) => {
        ...
        const body = {
            ...
            summary,
            // worksheetFile: FileUrlString ? FileUrlString : allWorksheetFileString
            worksheetFile: allWorksheetFileString,
            otherFiles: allFileString,
          }
                          ...
                          <div key={key3} className="col-md-6 mb-30">
                            ...
                            {allFile.map((i,index)=>(
                              ...
                              <p style={{cursor:'pointer', textDecoration:'underline', width:'70%'}} className="color-dark fs-14 fw-300 align-center mb-0"
                                ...
                                <p style={{color:'red'}} onClick={() => removeImage(index)}>Remove</p>
                                </div>
                                ))}
                          </div>
                          ...
                          <div key={key4} className="col-md-6 mb-30">
                            ...
                            {allWorksheetFile.map((i,index)=>(
                              ...
                              <p style={{cursor:'pointer', textDecoration:'underline', width:'70%'}} className="color-dark fs-14 fw-300 align-center mb-0"
                                ...
                                <p style={{color:'red'}} onClick={() => removeImage1(index)}>Remove</p>
                                </div>
                                ))}
                          </div>}
