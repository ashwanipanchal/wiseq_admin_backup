                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    ...
                                    <div className="layout-button">
                                        <NavLink className="" to="/invite_people"><button type="button" className="btn btn-outline-primary btn-squared color-primary">Invite</button></NavLink>
                                        <NavLink className="" to="/create_post"><button type="button" className="btn btn-primary btn-default btn-squared">Create Post</button></NavLink>
                                    </div>
