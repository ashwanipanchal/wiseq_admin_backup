...
function View_Testimonials() {
    ...
    const getProgramMentee = async() => {
        ...
        fetch(`${BASE_URL_APPLSURE_MENTORING}program-testimonials`, requestOptions)
        ...
        //     })
            console.log(result)
            setListOfAcceptedMentee(result?.alltestimonial)
    ...
    const getProgramMentor = async() => {
        ...
        .then(result => {
            ...
            // })
            console.log(result)
            setListOfAcceptedMentor(result?.alltestimonial)
                                ...
                                <div className="breadcrumb-main user-member justify-content-sm-between">
                                    <div className=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                                        <div className="d-flex align-items-center user-member__title justify-content-center me-sm-25">
                                            <h4 className="text-capitalize fw-500 breadcrumb-title">Testimonials</h4>
                                        </div>
                                    </div>
                                            ...
                                            <div className="dm-tab tab-horizontal">
                                                <Tabs >
                                                    <TabList className="nav nav-tabs vertical-tabs">
                                                        <Tab>Mentees Testimonials</Tab>
                                                        <Tab>Mentors Testimonials</Tab>
                                                    </TabList>
                                                                        ...
                                                                        <div className="ap-po-details-content d-flex flex-wrap justify-content-between align-center">
                                                                            <div className="media-body d-flex align-items-center mt-20 mx-10">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <p style={{color:'black'}} className="fs-12 fw-700 mb-0">{user?.message}</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
export default View_Testimonials;
